    ...
    <form method="POST" action="{{ route('students.update', $student) }}">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-3">
                ...
                <input type="date" name="birthdate" class="form-control" value="{{ old('birthdate', $student->birthdate) }}">
            </div>
            <div class="col-md-4">
                <label class="form-label">الرقم الجامعي</label>
                <input type="text" name="university_number" class="form-control" required value="{{ old('university_number', $student->university_number) }}">
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4" id="study_year_field" style="display:none;">
                ...
                <input type="number" name="study_year" class="form-control" value="{{ old('study_year', $student->study_year) }}">
            </div>
